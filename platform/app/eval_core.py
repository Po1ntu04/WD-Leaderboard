...
try:
    from .analytics_exports import build_sentence_table, evaluate_submission, export_standard_tables
...
def build_score_payload(
    ...
    *,
    ...
    if status == STATUS_SUCCESS:
        ...
        by_dataset = analytics['subset_scores'].get('source', {})
        by_difficulty = analytics['subset_scores'].get('difficulty', {})
        by_sentence_type = analytics['subset_scores'].get('sentence_type', {})
    ...
    submission_row = dict(analytics['submission_row'])
    submission_row['wrong_sentence_count'] = wrong_sentence_count
    submission_row['message'] = message
    ...
    report = {
        ...
        'overall': overall,
        'boundary_overall': {
            'precision': overall.get('boundary_precision', 0.0),
            'recall': overall.get('boundary_recall', 0.0),
            'f1': overall.get('boundary_f1', 0.0),
            'gold_boundaries': overall.get('gold_boundaries', 0),
            'pred_boundaries': overall.get('pred_boundaries', 0),
            'correct_boundaries': overall.get('correct_boundaries', 0),
        },
        ...
        'sentence_score_rows': analytics['sentence_score_rows'],
        'boundary_rows': analytics['boundary_rows'],
        'span_error_rows': analytics['span_error_rows'],
    }
    ...
    row = {
        ...
        'word_precision': overall.get('word_precision', overall.get('precision', 0.0)),
        'word_recall': overall.get('word_recall', overall.get('recall', 0.0)),
        'word_f1': overall.get('word_f1', overall.get('f1', 0.0)),
        'boundary_precision': overall.get('boundary_precision', 0.0),
        'boundary_recall': overall.get('boundary_recall', 0.0),
        'boundary_f1': overall.get('boundary_f1', 0.0),
        'exact_match_sentence_rate': overall.get('exact_match_sentence_rate', 0.0),
        'over_segmentation_count': overall.get('over_segmentation_count', 0),
        'under_segmentation_count': overall.get('under_segmentation_count', 0),
        'wrong_sentence_count': wrong_sentence_count,
        'tolerant_issue_count': issue_count,
        'message': message,
        'NLPCC-Weibo_f1': by_dataset.get('NLPCC-Weibo', {}).get('word_f1', by_dataset.get('NLPCC-Weibo', {}).get('f1')),
        'EvaHan-2022_f1': by_dataset.get('EvaHan-2022', {}).get('word_f1', by_dataset.get('EvaHan-2022', {}).get('f1')),
        'TCM-Ancient-Books_f1': by_dataset.get('TCM-Ancient-Books', {}).get('word_f1', by_dataset.get('TCM-Ancient-Books', {}).get('f1')),
        'samechar_f1': by_dataset.get('samechar', {}).get('word_f1', by_dataset.get('samechar', {}).get('f1')),
        'high_f1': by_difficulty.get('high', {}).get('word_f1', by_difficulty.get('high', {}).get('f1', 0.0)),
        'medium_f1': by_difficulty.get('medium', {}).get('word_f1', by_difficulty.get('medium', {}).get('f1', 0.0)),
        'specialized_f1': by_difficulty.get('specialized', {}).get('word_f1', by_difficulty.get('specialized', {}).get('f1', 0.0)),
    }
    return report, row
